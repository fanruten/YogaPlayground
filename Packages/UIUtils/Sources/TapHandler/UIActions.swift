...
extension UIControl {
    ...
    public func aru_setEventHandler(for controlEvents: UIControl.Event, _ action: (() -> Void)?) {
...
extension UIView {
    ...
    @discardableResult
    public func aru_addGestureRecognizer<GestureType: UIGestureRecognizer>(_ action: @escaping (GestureType) -> Void) -> GestureType {
